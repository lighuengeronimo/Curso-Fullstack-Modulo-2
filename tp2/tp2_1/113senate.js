...
for (i=0;i<members.length;i++){
  var fullName = members[i].middle_name == null ? members[i].first_name+" "+members[i].last_name : members[i].first_name + " " + members[i].middle_name +" "+ members[i].last_name;
  // chequea si el middle_name es null y si no lo es, lo suma al nombre completo
